...
var Hyphenator = (function (window) {
	...
	prompterStrings = {
		'be': '???? ?????? ????? ?? ???? ???? ????????? ???????????. ???? ????? ???????? ????:',
		'cs': 'Jazyk této internetové stránky nebyl automaticky rozpoznán. Ur?ete prosím její jazyk:',
		...
		'kn': '??? ???? ????????? ?????????? ????????????????. ???????? ????? ????????? ??????:',
		'lt': 'Nepavyko automatiškai nustatyti šios svetain?s kalbos. Prašome ?vesti kalb?:',
		'ml': '? ??%u0D2C%u0D4D%u200C?????????? ??? ???????????????%u0D28%u0D4D%u200D ??????????. ??? ????????? ??????????????:',
		'nl': 'De taal van deze website kan niet automatisch worden bepaald. Geef de hoofdtaal op:',
		'pt': 'A língua deste site não pôde ser determinada automaticamente. Por favor indique a língua principal:',
		'ru': '???? ????? ????? ?? ????? ???? ????????? ?????????????. ?????????? ??????? ????:',
		'sl': 'Jezika te spletne strani ni bilo mogo?e samodejno dolo?iti. Prosim navedite jezik:',
		'sv': 'Spr%E5ket p%E5 den h%E4r webbplatsen kunde inte avg%F6ras automatiskt. V%E4nligen ange:',
		'tr': 'Bu web sitesinin dili otomatik olarak tespit edilememi?tir. Lütfen döküman?n dilini seçiniz%A0:',
		'uk': '???? ????? ???-????? ?? ???? ???? ????????? ???????????. ???? ?????, ??????? ??????? ????:'
	},
...
Hyphenator.config({
	...
	hyphenchar : '-',
	remoteloading : false,
//	onhyphenationdonecallback : function () { h.updateSyllableCounts(); },
    safecopy : false
});
